...
function Gallery() {
  ...
  const imagesWithLinks = [
    ...
    { path: imagePaths[23], link: 'https://www.linkedin.com/feed/update/urn:li:activity:7077410592151543808/' },
    { path: imagePaths[24], link: null },
    { path: imagePaths[25], link: null },
    { path: imagePaths[26], link: 'https://www.hackster.io/Meadeor/meno-mirror-menopause-symptom-management-system-dc98db' },
    { path: imagePaths[27], link: null },
    { path: imagePaths[28], link: null },
    { path: imagePaths[29], link: 'https://www.hackster.io/Meadeor/crop-mapping-and-survey-drone-743363' },
    { path: imagePaths[30], link: null },
